...
//Metodo para comprar si la pila esta vacia
int estaVacia(){
  if (top == -1)
  return 1;
  else 
...
//Metodo para comprar si la pila esta llena
int estaLlena(){
  if (top==MAXSIZE)
  return 1;
  else 
...
int pop(){
	...
	printf("Elementos: \n");
	//Imprimimos los datos de la pila en el orden que feuron ingresados ingresados
